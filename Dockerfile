...
RUN conda activate awm_project && python manage.py collectstatic --no-input

# Apply database migrations
RUN conda activate awm_project && python manage.py makemigrations
RUN conda activate awm_project && python manage.py migrate
